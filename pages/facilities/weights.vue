    ...
    <div>
      <div class="relative">
        <PageHeader class="bg-top" height="h-72 lg:(h-small-img)"  pos="bg-top" img="https://res.cloudinary.com/defmmlrqg/image/upload/v1633426824/Pro%20Fitness/_SAM2513_2_hqkrrf.jpg"/>
            ...
            <h1 class="relative text-white flex  align-bottom justify-center  text-8xl  text-center font-bold md:(text-9xl leading-44 px-16 justify-center) tracking-wide w-full opacity-90">WEIGHTS</h1>
             </div>
        </div>
