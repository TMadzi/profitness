<template>
    <div>
      <div class="relative">
        <PageHeader class="bg-top" height="h-64 lg:(h-small-img)"  pos="bg-top" img="https://res.cloudinary.com/defmmlrqg/image/upload/v1633426709/Pro%20Fitness/292323_10150972309757226_650913718_n_nijuy5.jpg"/>
        <div class="bg-black absolute top-0 opacity-60 w-full h-full"></div>
        <h1 class="text-white flex  align-bottom justify-end  leading-44 absolute bottom-0 text-center font-bold text-banner tracking-wide w-full px-16">CARDIO</h1>
        </div>
