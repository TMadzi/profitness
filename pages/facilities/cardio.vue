<template>
    <div>
      <div class="relative">
        ...
        <h1 class="text-white flex  align-bottom justify-end  text-7xl absolute bottom-0 text-center font-bold md:(text-banner leading-44 px-16) tracking-wide w-full ">CARDIO</h1>
        </div>
        <section class="py-20 px-4 text-right bg-bgGrey">
          <h1 class="text-7xl font-bold text-gray-700"><span class="text-primary">STRENGTH.</span> TONING. <span class="text-primary">POWER.</span></h1>
    ...
    <div class="col-span-12 px-8 order-1 md:(col-span-6 py-16 pl-20 order-2) ">
      <h1 class="text-6xl uppercase font-bold mb-8 text-gray-700"><span class="text-primary">What is</span> Weight Training<span class="text-primary">?</span></h1>
      <p class="mb-6 text-gray-500 text-lg">Weight training uses cardios as a form of resistance to help make your muscles stronger. You can perform cardio training using free cardios (dumbbells, barbells and kettlebells) or by using machines.</p>
      <p class="mb-12 text-gray-500 text-lg">When doing cardio training, it is important that you use proper form and technique. We suggest that new/novice gym memebers schedule a session with a <nuxt-link to="/trainers" class="font-bold text-primary">personal trainer</nuxt-link> so that they can lerarn correct form and prevent serious injury.</p>
    </div>
  </section>
  <section class="grid grid-cols-12">
      <div class="col-span-12 px-8 order-1 md:(col-span-6 pl-8 py-16 pr-12 order-1) ">
      <h1 class="text-6xl uppercase font-bold mb-8 text-gray-700">Weight Training <span class="text-primary">Benefits</span></h1>
