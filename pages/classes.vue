<template>
    <div>
                <PageHeader class="bg-top" height="h-small-img" pos="bg-top" img="https://res.cloudinary.com/defmmlrqg/image/upload/c_scale,w_629/v1633426789/Pro%20Fitness/_SAM2540_uit74b.jpg"/>
              <SectionTitle class="mt-4" text1="Our" text2="Classes"  size="text-4xl" color2="text-primary" color1="text-gray-700" />
