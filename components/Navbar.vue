    ...
    >
      ...
      <div class="flex items-center">
        <div class="flex  md:justify-between md:bg-transparent">
          <button class="" aria-label="Open Menu" @click="drawer">
            <h1 class="uppercase text-primary font-bold text-xl text-center">
              Menu
            </h1>
          </button>
        </div>
      ...
      >
        ...
        <ul>
          ...
          <li @click="drawer">
            <nuxt-link class="p-4 flex font-bold text-xl text-primary transition ease duration-300 hover:(bg-primary text-white)" to="/trainers">
              Trainers
            </nuxt-link>
          </li>
          <li @click="drawer">
            <nuxt-link class="p-4 flex font-bold text-xl text-primary transition ease duration-300 hover:(bg-primary text-white)" to="/classes">
              Classes
            </nuxt-link>
          </li>
        </ul>
