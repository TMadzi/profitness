  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-4 space-y-4">
              ...
              <li>
                <nuxt-link to="/trainers" class="text-base text-gray-300 hover:text-white">
                  Trainers
                </nuxt-link>
              </li>

              <li>
                <nuxt-link to="/staff" class="text-base text-gray-300 hover:text-white">
                  Staff
                </nuxt-link>
              </li>
    ...
    <div class="mt-12 border-t border-gray-200 pt-8">
      <p class="text-base text-gray-200 xl:text-center">
        &copy; 2021 Pro Fitness Health Club.
      </p>
    </div>
  </div>
</footer>
